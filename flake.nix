{
  inputs = {
    ...
    nixpkgs-patch-bgutil-1-3-0 = {
      url = "https://github.com/NixOS/nixpkgs/pull/496700.patch";
      flake = false;
    };
    nixpkgs-patch-yt-dlp-26-03-03 = {
      url = "https://github.com/NixOS/nixpkgs/pull/496342.patch";
      flake = false;
    };
