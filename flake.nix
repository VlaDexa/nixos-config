{
  inputs = {
    ...
    # bcachefs-tools: 1.34.0 -> 1.35.0
    nixpkgs-patch-479655 = {
      url = "https://github.com/NixOS/nixpkgs/pull/479655.patch";
      flake = false;
    };
    # bcachefs-tools: 1.35.0 -> 1.35.1
    nixpkgs-patch-481201 = {
      url = "https://github.com/NixOS/nixpkgs/pull/481201.patch";
      flake = false;
    };
